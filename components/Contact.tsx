    ...
    <section id="contact" className="max-w-[1600px] mx-auto px-6 md:px-12 py-20 md:py-40">
      <div className="ultra-glass rounded-[3rem] md:rounded-[5rem] overflow-hidden flex flex-col lg:flex-row border-white/5 shadow-3xl">
        <div className="flex-1 p-8 md:p-16 lg:p-24 bg-gradient-to-br from-black to-blue-950/20">
          <h2 className="text-4xl md:text-7xl lg:text-8xl font-black tracking-tighter mb-8 md:mb-10 leading-[0.9] text-white uppercase">ACQUIRE <br /> DOMINANCE.</h2>
          ...
          <div className="space-y-10">
            <div className="flex items-center gap-8 group">
              <div className="w-14 h-14 rounded-2xl bg-white/[0.03] border border-white/5 flex items-center justify-center shadow-inner">
                <MapPin className="text-[#00FFC2] w-6 h-6" />
              </div>
              <div>
                <div className="text-[10px] font-mono uppercase tracking-widest text-slate-500 mb-2">Base of Operations</div>
                <div className="text-xl font-medium text-white">Business Bay, Dubai, UAE</div>
              </div>
            </div>
            <div className="flex items-center gap-8 group">
              ...
              <div>
                ...
                <div className="text-xl font-medium text-white">hello@apphub.ae</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 p-8 md:p-16 lg:p-24 bg-white/[0.01] backdrop-blur-3xl relative">
          {isSubmitted ? (
             ...
             >
               ...
               <h3 className="text-4xl font-black text-white mb-6 uppercase">Transmission Received</h3>
               ...
               <button 
                 ...
                 className="px-8 py-4 rounded-xl border border-white/10 text-white hover:bg-white/5 transition-all uppercase tracking-widest text-xs font-bold"
               >
                 Send Another Brief
               </button>
             </motion.div>
            ...
            <form className="space-y-10" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                <div className="space-y-4">
                  ...
                  <input 
                    ...
                    className="w-full bg-white/[0.03] border border-white/10 rounded-2xl py-5 px-8 focus:outline-none focus:border-[#00FFC2]/40 transition-all text-white placeholder:opacity-20" 
                  />
                </div>
                <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <textarea 
                  ...
                  rows={4} 
                  className="w-full bg-white/[0.03] border border-white/10 rounded-2xl py-5 px-8 focus:outline-none focus:border-[#00FFC2]/40 transition-all resize-none text-white placeholder:opacity-20"
                ></textarea>
              </div>
              <button 
                disabled={isSubmitting}
                className="w-full py-6 md:py-8 rounded-[2rem] bg-blue-600 text-white font-black text-lg md:text-xl uppercase tracking-[0.2em] flex items-center justify-center gap-4 hover:bg-blue-500 transition-all shadow-2xl group disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
